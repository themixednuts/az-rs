...
pub struct ThemeColor {
    ...
    pub type_accent_neutral: Hsla,
    /// Slate authored/runtime type glyph.
    pub type_accent_slate: Hsla,
    /// Level/scene type glyph.
    pub type_accent_level: Hsla,
    /// Prefab/UI type glyph.
    pub type_accent_prefab: Hsla,
    /// Material/slice/sun type glyph.
    pub type_accent_gold: Hsla,
    /// Light type glyph.
    pub type_accent_light: Hsla,
    /// Script/volume type glyph.
    pub type_accent_teal: Hsla,
    /// Terrain/texture type glyph.
    pub type_accent_terrain: Hsla,
    /// Audio type glyph.
    pub type_accent_audio: Hsla,
    /// Animation type glyph.
    pub type_accent_animation: Hsla,
    ...
    pub input: Hsla,
    /// Background color for recessed input surfaces.
