...
pub fn init(cx: &mut App) {
    ...
    // Ensure theme is loaded directly on startup while honoring the platform appearance.
...
impl Theme {
    ...
    ///
    /// Themes can author this independently from the input border so dense
    /// editor surfaces retain the intended recessed tone.
    #[inline]
