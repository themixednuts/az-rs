...
impl Window {
    ...
    /// Paint a typed transparent composition hole at the current scene order.
    /// The primitive carries the same clipped geometry and generation consumed
    /// by the Windows DirectComposition tree.
    pub fn paint_composition_hole(
        &mut self,
        bounds: Bounds<Pixels>,
        corner_radii: Corners<Pixels>,
        slot_id: u64,
        ...
        self.next_frame.scene.insert_primitive(CompositionHole {
            order: 0,
            bounds,
            content_mask,
            corner_radii,
