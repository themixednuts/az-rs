//! Compose-seam test for `azoth.audio-system`.
//!
...
use az_gem_audio_system::package_contribution;
use az_gem_contract::{Composer, Contribution, GemTargetRole, ProductActivation};
use azoth_audio_system_ids::{GEM, contributions::PACKAGE};
