...
impl BindingId {
    ...
    #[must_use]
    pub fn legacy_vararg(function: &FunctionId) -> Self {
        Self {
            function: function.clone(),
            slot: BindingSlot::LegacyVarArg,
        }
    }
...
/// Whether an emitted identifier came from source/debug data or was synthesized.
...
impl Name {
    ...
    /// Creates a synthesized identifier.
    ...
    /// Returns whether the identifier was synthesized by the decompiler.
    #[must_use]
...
impl FunctionName {
    ...
    #[must_use]
    pub const fn dotted(path: Vec<Name>) -> Self {
        Self { path, method: None }
    }

    /// Creates a colon-method function name.
    #[must_use]
    pub const fn method(path: Vec<Name>, method: Name) -> Self {
        Self {
            path,
            method: Some(method),
        }
...
impl FuncBody {
    ...
    #[must_use]
    pub const fn new(params: Vec<Name>, is_vararg: bool, body: Block) -> Self {
        Self {
