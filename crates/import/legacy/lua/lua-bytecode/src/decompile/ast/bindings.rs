...
#[must_use]
pub fn binding_usage_in_block(block: &Block, binding: &BindingId) -> BindingUsage {
...
#[must_use]
pub fn binding_usages_in_block(block: &Block) -> HashMap<BindingId, BindingUsage> {
...
#[must_use]
pub fn binding_references_in_func_body(body: &FuncBody, binding: &BindingId) -> bool {
...
#[must_use]
pub fn binding_spelling_available_in_block(
    block: &Block,
    binding: &BindingId,
    spelling: &[u8],
) -> bool {
...
#[must_use]
pub fn binding_spelling_available_in_func_body(
    body: &FuncBody,
    binding: &BindingId,
    spelling: &[u8],
) -> bool {
...
impl<'a> RenameInspection<'a> {
    const fn new(target: &'a BindingId, spelling: &'a [u8]) -> Self {
        Self {
            target,
            spelling,
            target_seen: false,
...
pub fn rename_binding_in_block(block: &mut Block, binding: &BindingId, spelling: &[u8]) {
...
pub fn rename_binding_in_func_body(body: &mut FuncBody, binding: &BindingId, spelling: &[u8]) {
