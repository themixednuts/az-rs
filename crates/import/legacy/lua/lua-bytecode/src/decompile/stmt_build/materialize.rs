use super::{
    Expr, LuaError, SsaNode, SsaOp, SsaRef, StatementBuilder, Stmt, ValuePlan, assign_one, closure,
    local_one, multi,
};
...
impl StatementBuilder<'_> {
    ...
    pub(super) fn emit_loadnil_range(&mut self, node: &SsaNode) -> Option<Stmt> {
